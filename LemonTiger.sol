...
contract LemonTiger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Lemon Tiger";
    string private _symbol = "Lemon Tiger";
    uint8 private _decimals = 2;

    uint256 _totalSupply = 1 * 10**10 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 10 )  / 1;

    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xFdecD25836Ba23B0042Fa9ECfb5b0558198c518a; 
